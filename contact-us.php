...
?>
    ...
    <div class="gmap_canvas"><iframe id="gmap_canvas" src="https://maps.google.com/maps?q=os&t=&z=13&ie=UTF8&iwloc=&output=embed" ></iframe>
    </div>
    <div class="contact-us-container">
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:+249999501483">+249999501483</a><br>
                <a href="tel:+249999553493">+249999553493</a></p>
            <h3>Address</h3>
            <p> City , Suez Desert Road , Cairo 11837 - P.O. Box 43</p>
            <h3>E-mail</h3>
            <p><a href="mailto:cinemareservation@os.edu.eg">cinemareservation@os.edu.eg</a></p>
        </div>
    </div>
    <footer></footer>
